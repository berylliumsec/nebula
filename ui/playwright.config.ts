...
export default selectedArgs.includes("tests/chat-reconnection.spec.ts") ? reconnection : selectedArgs.includes("tests/thinking.spec.ts") ? thinking : defineConfig({
  ...
  projects: [
    ...
    ].map(project => ({...project, testMatch: "**/real-core.spec.ts", grep: /assistant upgrade|project removal|project execution mode|mcp import|ssh environments/})),
    ...[
    ...
    },
    {
      ...
      grep: /provider options explain the working ceiling|working context panel|phone shell |tool suggestions |assistant popup|assistant settings expose provider metadata|Terminal opens Assistant beside the live shell|Assistant opens the live terminal beside the chat|browser Assistant |assistant upgrade|universal search opens|VPN settings keep|theme picker|host folder picker|project scope normalizes|mission workflow|mission result actions|completed harness output|activity ledger groups repeated work|assistant follow-up queue|assistant live guidance|assistant context pack|conversation switching|harness model controls|AI writing submits the visible supported model|New chat detaches|oversized harness activity|audit every primary workspace view|audit primary mutation dialogs|paired-device settings|mobile Workbench navigation|browser research tools expose durable workflows|product typography and touch contracts|shared actions keep sleek geometry|terminal screenshot capture|terminal VPN boundary|code editor keeps its caret|terminal and notes keep a visible focused caret|Zero keeps one navigable panoramic shell|editing a sent message|Phosphor icon pack/,
      use: { ...devices["Pixel 5"] },
    },
    {
      name: "mobile-chromium-ledger-390",
      testMatch: "**/interface.spec.ts",
      grep: /assistant popup|Terminal opens Assistant beside the live shell|Assistant opens the live terminal beside the chat|browser Assistant |assistant upgrade|activity ledger groups repeated work|assistant follow-up queue|conversation switching|Phosphor icon pack/,
      use: { ...devices["Pixel 5"], viewport: { width: 390, height: 844 } },
    },
    {
      name: "mobile-chromium-small",
      testMatch: "**/interface.spec.ts",
      grep: /phone shell |advanced session binding|assistant popup|Terminal opens Assistant beside the live shell|Assistant opens the live terminal beside the chat|browser Assistant |assistant upgrade|universal search opens|VPN settings keep|theme picker|host folder picker|project scope normalizes|mission workflow|mission result actions|completed harness output|activity ledger groups repeated work|assistant follow-up queue|assistant live guidance|assistant context pack|conversation switching|harness model controls|AI writing submits the visible supported model|New chat detaches|oversized harness activity|audit every primary workspace view|audit primary mutation dialogs|paired-device settings|mobile Workbench navigation|browser research tools expose durable workflows|product typography and touch contracts|shared actions keep sleek geometry|terminal screenshot capture|terminal VPN boundary|code editor keeps its caret|terminal and notes keep a visible focused caret|Zero keeps one navigable panoramic shell|editing a sent message|Phosphor icon pack/,
      use: { ...devices["Pixel 5"], viewport: { width: 320, height: 700 } },
    },
    {
      name: "mobile-chromium-wide",
      testMatch: "**/interface.spec.ts",
      grep: /phone shell |assistant popup|Terminal opens Assistant beside the live shell|Assistant opens the live terminal beside the chat|browser Assistant |assistant upgrade|universal search opens|VPN settings keep|theme picker|host folder picker|mission result actions|activity ledger groups repeated work|assistant follow-up queue|browser research tools expose durable workflows|completed harness output|terminal VPN boundary|conversation switching|Phosphor icon pack/,
      use: { ...devices["Pixel 5"], viewport: { width: 430, height: 932 } },
    },
    {
      name: "mobile-webkit-small",
      testMatch: "**/interface.spec.ts",
      grep: /phone shell |advanced session binding|assistant popup|Terminal opens Assistant beside the live shell|Assistant opens the live terminal beside the chat|browser Assistant |assistant upgrade|universal search opens|VPN settings keep|theme picker|host folder picker|mission result actions|activity ledger groups repeated work|assistant follow-up queue|browser research tools expose durable workflows|completed harness output|terminal VPN boundary|conversation switching|Phosphor icon pack/,
      use: { ...devices["iPhone 13"], viewport: { width: 320, height: 700 } },
    },
    {
      name: "mobile-webkit",
      testMatch: "**/interface.spec.ts",
      grep: /provider options explain the working ceiling|working context panel|phone shell |tool suggestions |assistant popup|assistant settings expose provider metadata|Terminal opens Assistant beside the live shell|Assistant opens the live terminal beside the chat|browser Assistant |assistant upgrade|universal search opens|VPN settings keep|theme picker|host folder picker|project scope normalizes|mission workflow|mission result actions|completed harness output|activity ledger groups repeated work|assistant follow-up queue|assistant live guidance|assistant context pack|conversation switching|harness model controls|AI writing submits the visible supported model|New chat detaches|oversized harness activity|audit every primary workspace view|audit primary mutation dialogs|paired-device settings|mobile Workbench navigation|browser research tools expose durable workflows|product typography and touch contracts|shared actions keep sleek geometry|terminal screenshot capture|terminal VPN boundary|code editor keeps its caret|terminal and notes keep a visible focused caret|Zero keeps one navigable panoramic shell|Phosphor icon pack/,
      use: { ...devices["iPhone 13"] },
    },
    {
      name: "mobile-webkit-wide",
      testMatch: "**/interface.spec.ts",
      grep: /phone shell |assistant popup|Terminal opens Assistant beside the live shell|Assistant opens the live terminal beside the chat|browser Assistant |assistant upgrade|universal search opens|VPN settings keep|theme picker|host folder picker|project scope normalizes|mission workflow|mission result actions|completed harness output|activity ledger groups repeated work|assistant follow-up queue|assistant context pack|conversation switching|harness model controls|AI writing submits the visible supported model|New chat detaches|oversized harness activity|audit every primary workspace view|audit primary mutation dialogs|paired-device settings|mobile Workbench navigation|browser research tools expose durable workflows|product typography and touch contracts|shared actions keep sleek geometry|terminal screenshot capture|terminal VPN boundary|code editor keeps its caret|terminal and notes keep a visible focused caret|Zero keeps one navigable panoramic shell|Phosphor icon pack/,
