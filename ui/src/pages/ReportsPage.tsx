...
export function ReportsPage() {
  ...
  const exportBundle = async () => {
    ...
    const approved = await confirm({
      ...
      message: "The bundle contains unredacted evidence, raw execution output, raw human-terminal audit results, PDFs, and audit records. Store and share it as sensitive data. Scratch workspace files are excluded unless promoted.",
