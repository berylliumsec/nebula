...
export function EvidencePage() {
  const { activeOperator, api, assets, engagement, evidence, findings, operatorProfiles, uploadEvidence } = useWorkspace();
  ...
  const submit = async (event: FormEvent) => {
    ...
    try {
      ...
      void logCaughtDiagnostic("interface.evidence_page.caught_failure_01", "A handled interface operation failed.", uploadError, "evidence_page");
  ...
  const download = async (item: EvidenceSummary) => {
    ...
    try {
      ...
      void logCaughtDiagnostic("interface.evidence_page.caught_failure_02", "A handled interface operation failed.", downloadError, "evidence_page");
