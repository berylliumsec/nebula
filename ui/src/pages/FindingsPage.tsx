...
import { Bug, CheckCircle2, GitCompareArrows, Plus, Search, ShieldAlert, X } from "lucide-react";
  ...
  return (
    <div className="page findings-page">
      ...
      <section className="panel data-panel">
        ...
        <footer className="table-footer"><span>Showing {visibleFindings.length} of {findings.length} loaded findings</span><span>Correlation state is supplied by Core</span></footer>
      </section>
