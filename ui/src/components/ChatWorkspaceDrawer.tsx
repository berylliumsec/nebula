...
export function ChatWorkspaceDrawer({children, tab, onTab, onClose, overlay = false}: {overlay?: boolean; children: ReactNode; tab: string; onTab: (tab: "context" | "results" | "subagents") => void; onClose: () => void}) {
