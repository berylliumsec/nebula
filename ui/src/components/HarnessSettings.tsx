...
export function HarnessSettings() {
  ...
  const harnessModelOptions = [...new Set([
    ...
    ...(kind === "claude_agent_sdk" && !editingHarness ? ["sonnet", "opus"] : []),
    ...(model ? [model] : []),
  ])];
