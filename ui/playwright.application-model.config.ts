...
export default defineConfig({
  testDir: "./tests", testMatch: "application-model.spec.ts", workers: 1, timeout: 60000,
  ...
  webServer: { command: `${process.env.NEBULA_TEST_PYTHON ?? "python"} ../tests/v3/application_model_fixture.py`, url: `http://${host}:${port}`, timeout: 60000, env: { NEBULA_APPLICATION_MODEL: "1" } },
});
