...
export default defineConfig({
  testDir: "./tests", testMatch: ["application-model.spec.ts", "application-model-responsive.spec.ts", "application-model-reset.spec.ts", "shared-browser-input.spec.ts"], workers: 1, timeout: 60000,
