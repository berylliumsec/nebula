...
| --- | --- | --- |
| [Main chat](https://www.figma.com/design/tVEa0PXZaa7H4ZLflwgcb7?node-id=4-73): create, select, reload | Core session/message identity and URL agree; provider choice survives | Canonical record validation only; create/select/refresh and persistence API parity pending |
...
| [Compact controls](https://www.figma.com/design/d7kSLlFfaUiDLE2GybUNqE?node-id=16-2): search, bookmark, catch up | Core messages/bookmarks/cursors are authoritative; pending actions stay visible | Records preserved; search, revisioned cursor writes and catch-up projection pending |
