...
_REFERENCE_RULES: dict[type[Entity], tuple[ReferenceRule, ...]] = {
    ...
    BrowserSession: (ReferenceRule("identity_id", BrowserIdentity),),
    BrowserTrafficExchange: (
        ReferenceRule("session_id", BrowserSession),
        ReferenceRule("identity_id", BrowserIdentity),
        ReferenceRule("scope_policy_id", ScopePolicy),
        ReferenceRule("request_body_artifact_id", Artifact),
        ReferenceRule("response_body_artifact_id", Artifact),
        ReferenceRule("replay_of_exchange_id", BrowserTrafficExchange),
    ),
    BrowserWebSocketFrame: (
        ReferenceRule("session_id", BrowserSession),
        ReferenceRule("exchange_id", BrowserTrafficExchange),
        ReferenceRule("payload_artifact_id", Artifact),
    ),
    BrowserAction: (
        ReferenceRule("session_id", BrowserSession),
        ReferenceRule("identity_id", BrowserIdentity),
    ...
    BrowserHandoff: (ReferenceRule("session_id", BrowserSession),),
    SoftwareComponent: (
    ...
    Evidence: (
        ...
        ReferenceRule("execution_id", OperatorExecution),
    ...
    OperatorExecution: (
        ...
        ReferenceRule("source_artifact_id", Artifact),
        ReferenceRule("stdout_artifact_id", Artifact),
        ReferenceRule("stderr_artifact_id", Artifact),
        ReferenceRule("redacted_stdout_artifact_id", Artifact),
        ReferenceRule("redacted_stderr_artifact_id", Artifact),
        ReferenceRule("manifest_artifact_id", Artifact),
        ReferenceRule("evidence_id", Evidence),
    ),
    GeneratedDraft: (
        ReferenceRule("execution_id", OperatorExecution),
        ReferenceRule("provider_profile_id", ProviderProfile, same_engagement=False),
        ReferenceRule("observation_id", Observation),
    ),
    Task: (
        ReferenceRule("run_id", AgentRun),
    ...
    ToolCall: (
        ...
        ReferenceRule("mcp_server_id", McpServerProfile, same_engagement=False),
        ReferenceRule("result_artifact_id", Artifact),
    ),
    Approval: (
        ReferenceRule("run_id", AgentRun),
        ReferenceRule("task_id", Task),
    ...
    ReportRender: (
        ReferenceRule("report_id", Report),
        ReferenceRule("snapshot_artifact_id", Artifact),
        ReferenceRule("pdf_artifact_id", Artifact),
    ),
}
